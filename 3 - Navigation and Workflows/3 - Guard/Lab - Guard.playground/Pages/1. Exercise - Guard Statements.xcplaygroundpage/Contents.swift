 ...
 */
func calcultateArea(_ x: Double,_  y: Double) -> Double? {
    guard x > 0 && y > 0 else {
        return nil
    }
    return x * y
}
calcultateArea(11,33)
calcultateArea(11,-3)
...
func add(integer1 : Int? , integer2 : Int?) -> Int?
{
        guard let integer1 = integer1 , let integer2 = integer2 else
        {
            return nil
        }
