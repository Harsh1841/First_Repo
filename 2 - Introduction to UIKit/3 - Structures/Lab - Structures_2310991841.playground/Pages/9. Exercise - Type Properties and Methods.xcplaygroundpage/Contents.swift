...
struct User {
    ...
    static var currentUser: User = User(userName: "Harshdeep", email: "harsh@example.com", age: 21)
...
let newUser = User(userName: "Harsh", email: "Harsh@example.com", age: 22)
User.logIn(user: newUser)

print("Updated User: \(User.currentUser.userName), Email: \(User.currentUser.email), Age: \(User.currentUser.age)")
