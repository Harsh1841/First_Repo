...
var user = User(name: "Harsh", age: 19, height: 1.78, weight: 58, activityLevel: 8)
print("Hello, my name is \(user.name)")
print("I am \(user.age) years old")
print("I am \(user.height) meters tall")
print("I weigh \(user.weight) kilograms")
print("I am \(user.activityLevel) out of 10 active")
...
print("\(distance.meters) ,  \(distance.feet)")

//:  Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
var mile = Distance(feet: 5249.344)
print("\(distance.meters) ,  \(distance.feet)")

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var anotherInstance = Distance(meters: 8046.72)
print("\(anotherInstance.meters) ,  \(anotherInstance.feet)")
