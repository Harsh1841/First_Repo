...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    let distancePaced = currentDistance / totalDistance
    let timePaced = currentTime / goalTime
    if distancePaced >= 1 && timePaced >= 1 {
        print("Keep it up!")
    } else {
...
pacing(currentDistance: 400, totalDistance: 1000, currentTime: 20, goalTime: 40)
/*:
